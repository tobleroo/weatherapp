...
public class GetTheWeather {
	...
	private Document weatherApi;

	public GetTheWeather(WeatherBean wBean) throws IOException {
		this.weatherApi = weatherDocument(wBean);
	}

	private Document weatherDocument(WeatherBean wBean) throws IOException{
		String API_KEY = "8bcce084d1a236d16eab9229d46cf9dc";
	...
	public String getWeather(String tag, String value) throws IOException {
		...
		NodeList nList = this.weatherApi.getElementsByTagName(tag);
		...
		for (int temp = 0; temp < nList.getLength(); temp++) {
			...
			if (node.getNodeType() == Node.ELEMENT_NODE) {
				...
				weatherData = eElement.getAttribute(value);
				// and print it
